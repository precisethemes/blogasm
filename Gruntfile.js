    ...
    grunt.initConfig({
        ...
        uglify: {
            js: {
                ...
                files: [
                    // Front End Library JS combine in one.
                    {
                        src: [
                            'assets/front-end/js/*.js',
                            '!assets/front-end/js/*.min.js',
                            '!assets/front-end/js/lib.js',
                            '!assets/front-end/js/custom.js',
                        ],
                        dest: 'assets/front-end/js/lib.js',
                    },
                ...
                files: [
                    ...
                    // Front End Library CSS Minify
                    {
                        src: [
                            ...
                            '!assets/front-end/css/lib.css',
                        ],
                        dest: 'assets/front-end/css/lib.css',
                    },
        ...
        makepot: {
            target: {
                options: {
                    domainPath: '/',
                    potFilename: 'languages/blogasm.pot',
                    potHeaders: {
                        poedit: true,
        ...
        checktextdomain: {
            standard: {
                options:{
                    text_domain: 'blogasm', //Specify allowed domain(s)
