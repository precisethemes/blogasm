...
if ( ! class_exists( 'PAnD' ) ) {
    ...
    class PAnD {
        ...
        public static function load_script() {
            ...
            wp_enqueue_script( 'blogasm-dismissible-notices', BLOGASM_THEME_URI . '/assets/back-end/js/dismiss-notice' .$min. '.js', array( 'jquery', 'common' ), false, true );

            wp_localize_script( 'blogasm-dismissible-notices', 'dismissible_notice',
                array(
